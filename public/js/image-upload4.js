function ImageUpload(divId, options = {}) {
    ...
    this.defaultOptions = {
        ...
        alertServerTimeout: function() {
            addFlashBox('Server time out', 2000, '#f00e0e');
        },
        ...
        alertMaxImages: function () {
            addFlashBox('Maximum images is: ' + returnOptionValue('maxImages'), 2000, '#f00e0e');
        },

        //Show alert when server error occured when sending XMLHttpRequest (AJAX).
        alertServerError: function() {
            addFlashBox('Server Error', 2000, '#f00e0e');
        },
        ...
        minSizeImageUploadedAlert: function() {
            addFlashBox('Image too small', 2000, '#e30b0b');
        },
        ...
        sameImageUploadedAlert: function() {
            addFlashBox('Image have been uploaded', 2000, '#e30b0b');
        },
        ...
        showAlertMimeType: function() {
            addFlashBox('Wrong image type', 2000, '#e30b0b');
        },
                ...
                if (satisfiedFileSizeArrayLength > 0) {
                    ...
                    for (var i = 0; i < satisfiedFileSizeArrayLength; i++) {
                        ...
                        if (insertBeforeElmnt) {
                            gallery.insertBefore(imageUploadingPlaceHolder, insertBeforeElmnt);
                        }
                        else {
                            gallery.appendChild(imageUploadingPlaceHolder);
                        }
    ...
    function appendImage(savedImage, imageName, savedImageId) {
        ...
        if (progressPercentBar === true) {
            ...
            // fadeOutEffect(spinner);
            // fadeOutEffect(percentDiv);
        }
