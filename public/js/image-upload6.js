function ImageUpload(divId, options = {}) {
    ...
    this.defaultOptions = {
        ...
        //Boolean. Allow user to move image to change image order number by dragging or not.
        allowDragImage: true,

        //Number in miliseconds
        touchDuration: 1000,

        //Function to change image style after user press on image longer than touch duration.
        //Purpose is to show image is ready to be drag to change order
        //The target is the image item is being pressed
